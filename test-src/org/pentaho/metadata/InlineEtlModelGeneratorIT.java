...
public class InlineEtlModelGeneratorIT {
  ...
  public void testGenerator() throws Exception {
    ...
    InlineEtlModelGenerator gen =
        new InlineEtlModelGenerator( "testmodel", "test-res/solution/system/metadata/csvfiles/", "example.csv", true,
  ...
  public void testQueryExecution() throws Exception {
    ...
    IPentahoResultSet resultset = executor.executeQuery( query, "test-res/solution/system/metadata/csvfiles/", null );
  ...
  public void testQueryExecutionWithOrder() throws Exception {
    ...
    InlineEtlQueryExecutor executor = new InlineEtlQueryExecutor();
    executor.setCsvFileLoc( "test-res/solution/system/metadata/csvfiles/" );
    ...
    resultset = executor.executeQuery( query2, "test-res/solution/system/metadata/csvfiles/", null );
  ...
  public void testQueryExecutionWithConstraints() throws Exception {
    ...
    resultset = executor.executeQuery( query4, "test-res/solution/system/metadata/csvfiles/", null );
    ...
    resultset = executor.executeQuery( query45, "test-res/solution/system/metadata/csvfiles/", null );
    ...
    resultset = executor.executeQuery( query5, "test-res/solution/system/metadata/csvfiles/", null );
    ...
    resultset = executor.executeQuery( query6, "test-res/solution/system/metadata/csvfiles/", null );
    ...
    resultset = executor.executeQuery( query6, "test-res/solution/system/metadata/csvfiles/", params );
    Assert.assertEquals( 5, resultset.getRowCount() );
  ...
  public void testQueryExecutionWithFormulaFunctions() throws Exception {
    ...
    resultset = executor.executeQuery( query, "test-res/solution/system/metadata/csvfiles/", null );
  ...
  public void testQueryExecutionAllAggregations() throws Exception {
    ...
    int defaultAcls = 31;
    InlineEtlModelGenerator gen =
        new InlineEtlModelGenerator( "testmodel", "test-res/solution/system/metadata/csvfiles/", "People.csv", true,
            ",", "\"", true, users, roles, defaultAcls, "joe" );
