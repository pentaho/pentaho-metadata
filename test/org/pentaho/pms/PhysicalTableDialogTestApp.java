...
public class PhysicalTableDialogTestApp extends ApplicationWindow {
  ...
  protected Control createContents(final Composite parent) {
    ...
    final TableDialog diag = new TableDialog(this.getShell(), SWT.NONE, copy, locales, null,
        new PhysicalTableAddColumnHandler());
  ...
  protected class PhysicalTableAddColumnHandler implements TableDialog.AddColumnHandler {

    public void handleAddColumn(Shell shell, ITableModel tableModel, String activeLocale) {
      // Ask for the ID
