...
public class SybaseDialectTest extends MetadataTestBase {
  ...
  public void testNoLimitSQL() {
    assertSelect("SELECT DISTINCT t.id FROM TABLE t WHERE ( ( t.id is null ) ) ORDER BY t.id ASC", new SybaseDialect(),
