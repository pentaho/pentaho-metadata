...
public class SpiderWebTestModel {
  ...
  private BusinessTable createBusinessTable(String tblId, BusinessModel model, BusinessCategory mainCat) throws Exception {
  ...
  private BusinessColumn createBusinessKeyColumn(String tblId, String columnId, BusinessTable tbl, BusinessCategory cat) throws Exception {
  ...
  private void createRelationship(BusinessTable from, BusinessTable to, int fromColId, int toColId, BusinessModel model) throws Exception {
