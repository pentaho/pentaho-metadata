...
public class TestModelProvider implements ModelProvider {
	...
	public DataTable executeQuery( Query query, int rowLimit ) {
		...
		List<org.pentaho.metadata.datatable.Column> tableColumnList = new ArrayList<org.pentaho.metadata.datatable.Column>();
		...
		org.pentaho.metadata.datatable.Column tableColumns[] = tableColumnList.toArray(new org.pentaho.metadata.datatable.Column[tableColumnList.size()]);
