...
public class SpiderWebTestModel {
  ...
  private LogicalColumn createBusinessKeyColumn(String tblId, String columnId, LogicalTable tbl, Category cat) throws Exception {
  ...
  private void createRelationship(LogicalTable from, LogicalTable to, int fromColId, int toColId, LogicalModel model) throws Exception {
