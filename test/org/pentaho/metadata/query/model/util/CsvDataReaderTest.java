...
public class CsvDataReaderTest {
  ...
  public void testLoadData() throws Exception {
    CsvDataReader reader =
        new CsvDataReader( "test/solution/system/metadata/csvfiles/anotherexample.csv", true, ",", "\"", 5 );
    ...
    final String complexFileName = "test/solution/system/metadata/csvfiles/mixed-line-endings.csv";
  ...
  public void testCheckForIndexOutOfBoundException() throws Exception {
    ...
    try {
      CsvDataReader reader =
          new CsvDataReader( "test/solution/system/metadata/csvfiles/csv_various_types.csv", true, ",", "\"", 5 );
      reader.loadData();
