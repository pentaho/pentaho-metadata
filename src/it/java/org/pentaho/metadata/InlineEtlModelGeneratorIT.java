...
public class InlineEtlModelGeneratorIT {
  ...
  public static void initKettle() throws Exception {
    ...
    csvFilesPath = InlineEtlModelGeneratorIT.class.getResource( "/solution/system/metadata/csvfiles/" ).getPath();
  }
  ...
  public void testQueryExecutionWithOrder() throws Exception {
    ...
    InlineEtlQueryExecutor executor = new InlineEtlQueryExecutor();
    executor.setCsvFileLoc( csvFilesPath );
    ...
    resultset = executor.executeQuery( query2, csvFilesPath, null );
  ...
  public void testQueryExecutionWithConstraints() throws Exception {
    ...
    resultset = executor.executeQuery( query4, csvFilesPath, null );
    ...
    resultset = executor.executeQuery( query45, csvFilesPath, null );
    ...
    resultset = executor.executeQuery( query5, csvFilesPath, null );
    ...
    resultset = executor.executeQuery( query6, csvFilesPath, null );
    ...
    resultset = executor.executeQuery( query6, csvFilesPath, params );
    Assert.assertEquals( 5, resultset.getRowCount() );
  ...
  public void testQueryExecutionWithFormulaFunctions() throws Exception {
    ...
    resultset = executor.executeQuery( query, csvFilesPath, null );
  ...
  public void testQueryExecutionAllAggregations() throws Exception {
    ...
    int defaultAcls = 31;
    InlineEtlModelGenerator gen =
        new InlineEtlModelGenerator( "testmodel", csvFilesPath, "People.csv", true,
            ",", "\"", true, users, roles, defaultAcls, "joe" );
