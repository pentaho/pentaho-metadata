...
public class OlapUtilIT {
  ...
  public void setUp() throws Exception {
    ...
    BufferedReader cubesBufferedReader =
      new BufferedReader( new InputStreamReader( getClass().getResourceAsStream( "/olap-cubes-sample.xml" ) ) );
    while ( cubesBufferedReader.ready() ) {
      sampleCubesXml += cubesBufferedReader.readLine();
    }
    cubesBufferedReader.close();

    BufferedReader rolesBufferedReader =
      new BufferedReader( new InputStreamReader( getClass().getResourceAsStream( "/olap-roles-sample.xml" ) ) );
  ...
  public void testOlapRoleFromNode() throws Exception {
    ...
    Document document = documentBuilder.parse( getClass().getResourceAsStream( "/olap-roles-sample.xml" ) );
