...
/**
 * Represents a bi-directional relationship between two <code>Node</code>
 * objects that will be reviewed by the graph to determine if it
 * is required to connect all necessary <code>Node</code> objects.
 * 
 * @author Nick Coleman
 */
public class Arc implements GraphElement {
	...
	/**
	 * Returns true if this <code>Arc</code> is known to be required 
	...
	/**
	 * Enforces the constraints of this <code>Arc</code> on related
	 * <code>Nodes</code>. This method is called during propagation
	 * of changes in a graph when a <code>Node</code> changes.
	 * 
