...
//   * @throws PentahoMetadataException throws an exception if we're missing anything important
//   */
//  public AliasAwareSqlOpenFormula(LogicalModel model, LogicalTable table, String formulaString, String aliasName) throws PentahoMetadataException {
...
//  }
  ...
  protected void renderContextLookup(StringBuffer sb, String contextName, String locale) {
    ...
    if (sel != null) {
      sb.append(" "); //$NON-NLS-1$
      AdvancedSqlGenerator.SQLAndAliasedTables sqlAndTables = AdvancedSqlGenerator.getSelectionSQL(getLogicalModel(), sel, getDatabaseMeta(), locale);
    ...
    if (column == null) {
      ...
      // render the column sql
      sb.append(" "); //$NON-NLS-1$
      AdvancedSqlGenerator.SQLAndAliasedTables sqlAndTables = AdvancedSqlGenerator.getSelectionSQL(getLogicalModel(), selection, getDatabaseMeta(), locale);
      sb.append(sqlAndTables.getSql());
      sb.append(" "); //$NON-NLS-1$
