...
public abstract class ConceptTreeNode extends TreeNode {
  ...
  /**
   * 
   * @param businessObject an object from the meta-model - ie., BusinessTable, BusinessColumn, etc.
  ...
  /**
   * recursively sort the child nodes in ascending order, then synchronize the changes 
   *
   */
   ...
   * @param modelList the list of business objects from the business model that we will sync with
   */
