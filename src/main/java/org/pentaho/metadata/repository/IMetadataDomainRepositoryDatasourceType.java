 ...
 */
public interface IMetadataDomainRepositoryDatasourceType extends IMetadataDomainRepository {
     ...
     */
    public Set<String> getDomainIdsMetadata();
     ...
     */
    public Set<String> getDomainIdsDataSourceWizard();
}
