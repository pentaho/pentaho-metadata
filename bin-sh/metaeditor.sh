...
# ** Change 1024m to higher values in case you run out of memory. **
# ******************************************************************

OPT="-Xms1024m -Xmx2048m -cp $CLASSPATH -Djava.library.path=$LIBPATH"

# ***************
# ** Run...    **
# ***************

$JAVA_BIN $OPT org.pentaho.pms.editor.MetaEditor "$1" "$2" "$3" "$4" "$5" "$6" "$7" "$8" "$9"
